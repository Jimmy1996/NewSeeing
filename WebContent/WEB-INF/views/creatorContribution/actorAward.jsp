...
<body>
	<header>
        ...
        <div id="wrap">      
               <div id="left">
                     <!--演员提名及获奖情况-->
                    <div id="actorAward_Area">
                         <p>nominations and awards>>></p>
                         <div class="centerArea_all">
                         <div id="actorAward_charts" style="padding-left:0px;top:10px;height:480px;width:660px"></div>
                         </div>
                    </div>
                </div>
               <div id="menuright">
    ...
    <%@ include file="../../../public/javascript/meme/eight-Contribution/actorAward_charts1.jsp" %>
