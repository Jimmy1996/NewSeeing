...
<body>
	<header>
        ...
        <div id="wrap">      
               <div id="left">
                     <!--百度搜索指数-->    
                     <div id="baiduSearch_Area">
                             <p>baidu searches>>></p>
                             <div class="centerArea_all">
                                 <div id="baiduSearch_charts"  style="padding-left:30px;height:470px;width:670px"></div>
                             </div>
                     </div>
                       </div>
               <div id="menuright">
    ...
    <%@ include file="../../../public/javascript/meme/eight-Contribution/baiduSearchCharts1.jsp" %>
