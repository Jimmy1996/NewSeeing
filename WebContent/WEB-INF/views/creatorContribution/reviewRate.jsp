...
<body>
	<header>
        ...
        <div id="wrap">      
               <div id="left">
                     <!--评论涉及率-->
                     <div id="reviewRate_Area">
                            <p>word of mouth>>></p>
                            <div class="centerArea_all">
                                     <div id="reviewRate_charts" style="height:500px;width:700px"></div>
                            </div>
                      </div>
                       </div>
               <div id="menuright">
    ...
    <%@ include file="../../../public/javascript/meme/eight-Contribution/reviewRate_charts1.jsp" %>
