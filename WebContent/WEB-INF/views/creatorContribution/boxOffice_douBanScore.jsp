...
<head>
	<meta charset="UTF-8">
	<title>boxOffice_douBanScore</title>
...
<body>
	<header>
        ...
        <div id="wrap">      
               <div id="left">
                      <!--票房与豆瓣评分-->
                    <div id="boxOffice_douBanScore_Area">
                         <p>score of douban>>></p>
                         <div class="centerArea_all">
                               <div id="boxOffice_douBanScore_charts"  style="padding-left:10px;top:20px;height:480px;width:770px"></div>
                         </div>
                    </div>
    ...
    <%@ include file="../../../public/javascript/meme/eight-Contribution/boxOffice_douBanScore_charts1.jsp" %>
