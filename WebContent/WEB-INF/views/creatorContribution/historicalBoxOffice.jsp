...
<head>
	<meta charset="UTF-8">
	<title>historicalBoxOffice</title>
...
<body>
	<header>
        ...
        <div id="wrap">      
               <div id="left">
                     <!-- 历史票房-->
                     <div id="historicalBoxOffice_Area">
                            <p>historical box office>>></p>
                            <div class="centerArea_all scrollbar" style="max-height:460px;">
                                   <div id="historicalBoxOffice_charts"  style="top:30px;padding-left:40px;height:700px;width:740px"></div>
                           </div>
                     </div>                      
                </div>
    ...
    <%@ include file="../../../public/javascript/meme/eight-Contribution/historicalBoxOffice_charts1.jsp" %>
