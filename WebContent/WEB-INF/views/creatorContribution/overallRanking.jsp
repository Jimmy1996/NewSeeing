...
<body>
	<header>
        ...
        <div id="wrap">      
               <div id="left">
                     <!--总体排行榜-->
                    <div id="overallRanking_Area">
                         <p>overall ranking>>></p>
                         <div class="centerArea_all">
                                <div id="overallRanking_charts" style="top:20px;padding-left:20px;height:490px;width:670px"></div>
                         </div>
                    </div>   
                </div>
              <div id="menuright">
	...
	<!----	<p>copyright©广东外语外贸大学 广外数据挖掘实验室</p> ------>
     ...
     <%@ include file="../../../public/javascript/meme/eight-Contribution/overallRanking_charts1.jsp" %>
