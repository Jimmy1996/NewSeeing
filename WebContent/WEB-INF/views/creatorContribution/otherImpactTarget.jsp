...
<body>
	<header>
       ...
       <div id="menu">       
        ...
        <div id="wrap">      
               <div id="left">
                      <!--其他影响指标-->    
                     <div id="otherImpactTarget_Area">
                            <p>others>>></p>
                            <div id="otherImpactTarget_charts"  style="margin-top:30px;margin-left:230px;height:480px;width:600px"></div>
                     </div>
    ...
    <%@ include file="../../../public/javascript/meme/eight-Contribution/otherImpactTarget_charts1.jsp" %>
